...
using PayPal_Requester.Properties;
...
namespace PayPal_Requester
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            paymenturlTxt.Text = Settings.Default["paymenturl"].ToString();
            ...
            else
            {
               ...
               //build email body
                string myemailbody = "<p>Hi " + txtName.Text +",</p>"
                          + "<p>You have an order waiting for payment. Please use the link below to pay via PayPal (which accepts all major credit cards) or give"
                          + " us a call at " + Settings.Default["companyphone"].ToString() + ".</p>"
                          + "<p>Order Number: " + OrderNumber.Text + "<br>"
                          + "Order Description: " + AdditionalMessage.Text + "<br>"
                          + "Amount: $" + Amount.Text + "</p>"
                          + "<p><a href=\"" + Settings.Default["paymenturl"].ToString() + "?orderid=" + OrderNumber.Text + "&amount=" + Amount.Text +"\">Click here to Pay Online</a>"
                          +"<p>Thanks!<br>"
                          + Settings.Default["companyname"].ToString() + "<br>"
                          + Settings.Default["companywebsite"].ToString() + "</p>"
                          ;
                string myemailsubject = "Payment Request from "  + Settings.Default["companyname"].ToString();
        ...
        private void savesettingsBtn_Click(object sender, EventArgs e)
        {
            ...
            Settings.Default["paymenturl"] = paymenturlTxt.Text;
